...
const AboutUs = () => {
  return (
    <div className="bg-gradient-to-br from-red-600 to-red-800 text-center text-white p-6">
      <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold my-3 ">
        About Us
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mx-auto max-w-6xl">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-lg">Provide lifesaving education and awareness.</p>
        </div>
        <div className="flex flex-col items-center">
          <div className="text-4xl text-yellow-400 mb-2">
            <FaBookOpen />
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-lg">Foster a culture of giving and compassion.</p>
        </div>
        <div className="flex flex-col items-center">
          <div className="text-4xl text-yellow-400 mb-2">
            <FaGlobe />
          </div>
          <p className="text-lg">Extend our reach to communities worldwide.</p>
        </div>
        <div className="flex flex-col items-center">
          <div className="text-4xl text-yellow-400 mb-2">
            <FaMedal />
